...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card shadow-lg p-4 rounded" style="max-width: 600px; width: 100%;">
            <h2 class="text-center mb-4"><strong>Congratulations!</strong></h2>
            <div class="text-center mb-4 p-4 border rounded shadow-sm" style="background-color: #f9f9f9; max-width: 600px; margin: 0 auto;">
                <h3 class="mb-3" style="color: #4CAF50;">Enrollment Successful!</h3>
                <p class="lead mb-4" style="font-size: 1.1rem;">Your enrollment has been successfully submitted!</p>
                <p class="mb-4" style="font-size: 1.1rem;">Please check your email for further instructions:</p>
                <ul class="list-unstyled">
                    <li class="mb-3">
                        <span class="font-weight-bold" style="color: #007bff;">If you chose online payment:</span> Please wait for the confirmation email.
                    </li>
                    <li>
                        <span class="font-weight-bold" style="color: #007bff;">If you chose walk-in payment:</span> Please visit your enrollment branch to settle the payment.
                    </li>
                </ul>
            </div>
            <div class="text-center">
                <a href="{{ route('home') }}" class="btn btn-primary">Go Back to the Home Page</a>
            </div>
        </div>
    </div>
